...
namespace Micube.SmartMES.ProcessManagement
{
	...
	/// 
	/// </summary>
	public partial class WorkResult : SmartConditionManualBaseForm
	{
		...
		private void InitializeEvent()
		{
            ...
            Conditions.GetControl<SmartSelectPopupEdit>("P_PRODUCTDEFID").ButtonClick += WorkResult_ButtonClick;

            Conditions.GetControl<SmartSelectPopupEdit>("P_PRODUCTDEFID").EditValueChanged += WorkResult_EditValueChanged; ;
        }

        private void WorkResult_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void WorkResult_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
        ...
        private void grdByAreaView_DoubleClick(object sender, EventArgs e)
        {
            ...
            tabWorkResult.SelectedTabPage = tabWorkResult.TabPages[2];
		...
		protected async override Task OnSearchAsync()
		{
            ...
            SmartBandedGrid grid = tabWorkResult.SelectedTabPageIndex.Equals(0) ? grdByArea :
                                   tabWorkResult.SelectedTabPageIndex.Equals(1) ? grdByProduct : grdByLot;

            values["TYPE"] = tabWorkResult.SelectedTabPageIndex.Equals(0) ? "BYAREA" :
                          tabWorkResult.SelectedTabPageIndex.Equals(1) ? "BYPRODUCT" : "BYLOT";

            grid.View.ClearDatas();

            if (await QueryAsync("SelectWorkResultList", "10001", values) is DataTable dt)
            {
		...
		protected override void InitializeCondition()
		{
            ...
            Conditions.GetCondition<ConditionItemDateEdit>("P_SEARCHDATE").SetValidationIsRequired();
			//대공정
        ...
        protected override void OnToolbarClick(object sender, EventArgs e)
        {
            ...
            {
                // 조회일자
                Conditions.GetControl<SmartDateEdit>("P_SEARCHDATE").EditValue = DateTime.Now;
