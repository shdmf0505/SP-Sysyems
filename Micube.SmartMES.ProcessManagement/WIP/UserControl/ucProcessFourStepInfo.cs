...
{
    public delegate void delUnitChanged();
    ...
    /// 
    /// </summary>
    public partial class ucProcessFourStepInfo : UserControl
    {
        ...
        public event delUnitChanged unitChanged;
        public ucProcessFourStepInfo()
        {
            InitializeComponent();
        ...
        {
            tlpComment.ColumnStyles[0].Width = lblGoodQty.Width;
            tlpTransitArea.ColumnStyles[0].Width = lblGoodQty.Width;
        }
        ...
        [Browsable(false)]
        public bool TransitAreaVisible
        {
            get
            {
                return tlpTransitArea.Visible;
            }
            set
            {
                tlpTransitArea.Visible = value;
            }
        }
            ...
            switch (ProcessType)
            {
                ...
                case ProcessType.WorkCompletion:
                    ...
                    if (!stepType.Split(',').Contains("WaitForSend"))
                    {
                        ...
                        {
                            // TODO : Resource
                            lblTransitArea.Text = Language.Get("TRANSITAREA");
                            cboTransitArea.ValueMember = "AREAID";
                            cboTransitArea.DisplayMember = "AREANAME";
                        ...
                        {
                            // TODO : Resource
                            lblTransitArea.Text = Language.Get("TRANSITRESOURCE");
                            cboTransitArea.ValueMember = "RESOURCEID";
                            cboTransitArea.DisplayMember = "RESOURCENAME";
                        ...
                        cboTransitArea.ComboBoxColumnShowType = ComboBoxColumnShowType.DisplayMemberOnly;
                        cboTransitArea.ShowHeader = false;
                        // TODO : Resource
                        //cboTransitArea.Editor.ValueMember = "AREAID";
                        //cboTransitArea.Editor.DisplayMember = "AREANAME";
                        cboTransitArea.UseEmptyItem = true;
                        cboTransitArea.EmptyItemValue = "";
                        cboTransitArea.EmptyItemCaption = "";
                        //cboTransitArea.Editor.DataSource = SqlExecuter.Query("GetTransitAreaList", "10001", transitAreaParam);
                        cboTransitArea.DataSource = transitAreaList;
                        cboTransitArea.EditValue = string.IsNullOrEmpty(primaryAreaId) ? cboTransitArea.EmptyItemValue : primaryAreaId;
                        break;
                    }
                    else
                    {
                        ...
                        cboTransitArea.DataSource = null;
                    }
        ...
        */
        ...
        public Dictionary<string, object> GetValues()
        {
            ...
            if (tlpTransitArea.Visible)
            {
                if (cboTransitArea.ValueMember == "AREAID")
                {
                    result.Add("TRANSITAREA", cboTransitArea.EditValue.ToString());
                }
                else if (cboTransitArea.ValueMember == "RESOURCEID")
                {
                    result.Add("RESOURCEID", Format.GetString(cboTransitArea.EditValue));
                    result.Add("TRANSITAREA", Format.GetString(cboTransitArea.GetColumnValue("AREAID")));
                }
            }
            ...
            result.Add("COMMENT", txtComment.Text);
