...
namespace Micube.SmartMES.ProcessManagement
{
    ...
    /// 
    /// </summary>
    public partial class MultiLotWorkEnd : SmartConditionManualBaseForm
    {
        ...
        protected override void OnToolbarSaveClick()
        {
            ...
            MessageWorker worker = new MessageWorker("SaveMultiLotWorkEnd");
