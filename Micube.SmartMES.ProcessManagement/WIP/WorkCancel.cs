...
namespace Micube.SmartMES.ProcessManagement
{
    ...
    /// 
    /// </summary>
    public partial class WorkCancel : SmartConditionManualBaseForm
    {
        ...
        protected override void OnToolbarSaveClick()
        {
            ...
            MessageWorker mw = new MessageWorker("SaveTrackInCancelLot");
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            values.Add("PROCESSSTATE", "Run");
            values.Add("PREVPROCESSSTATE", "Wait");
            values.Add("TRANSITTYPE", "TrackInCancel");
