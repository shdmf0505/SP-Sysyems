...
namespace Micube.SmartMES.ToolManagement
{
    ...
    /// 
    /// </summary>
    public partial class ReceiptMoveFilm : SmartConditionManualBaseForm
    {
        ...
        private void InitializeGrid()
        {
            ...
            grdToolMoveList.View.AddTextBoxColumn("FILMNO", 150)                        //Tool번호
                .SetIsReadOnly(true);
            grdToolMoveList.View.AddTextBoxColumn("FILMCODE", 130)                        //Tool번호
                .SetIsReadOnly(true);
            grdToolMoveList.View.AddTextBoxColumn("FILMVERSION", 120)                        //Tool번호
                .SetIsReadOnly(true);
            grdToolMoveList.View.AddTextBoxColumn("FILMNAME", 400)                        //Tool번호
                .SetIsReadOnly(true);            
            ...
            grdToolMoveList.View.AddTextBoxColumn("PRODUCTDEFVERSION", 80)
                .SetIsReadOnly(true);                                                       //품목REV
            ...
            grdToolMoveList.View.AddTextBoxColumn("ISMODIFY")
                .SetIsHidden();                                                             //작업장권한여부
            ...
            grdToolMoveList.View.AddTextBoxColumn("JOBTYPEID")
                .SetIsHidden();                                                             //작업구분아이디
            grdToolMoveList.View.AddTextBoxColumn("JOBTYPE", 80)
                .SetTextAlignment(TextAlignment.Center)
                .SetIsReadOnly(true);                                                       //작업구분
            grdToolMoveList.View.AddTextBoxColumn("PRODUCTIONTYPEID")
                .SetIsHidden();                                                             //생산구분아이디
            grdToolMoveList.View.AddTextBoxColumn("PRODUCTIONTYPE", 80)
                .SetTextAlignment(TextAlignment.Center)
                .SetIsReadOnly(true);                                                       //생산구분
            grdToolMoveList.View.AddTextBoxColumn("CUSTOMERID")
               .SetIsHidden();                                                             //고객아이디
            grdToolMoveList.View.AddTextBoxColumn("CUSTOMER", 120)
                .SetTextAlignment(TextAlignment.Center)
                .SetIsReadOnly(true);                                                       //고객
            ...
            grdToolMoveList.View.AddTextBoxColumn("FILMTYPEID")
                .SetIsHidden();                                                         //필름구분아이디
            grdToolMoveList.View.AddTextBoxColumn("FILMTYPE", 100)
                .SetIsReadOnly(true);                                                   //필름구분
            grdToolMoveList.View.AddTextBoxColumn("FILMCATEGORYID")
                .SetIsHidden();                                                         //필름유형아이디
            grdToolMoveList.View.AddTextBoxColumn("FILMCATEGORY", 120)
                .SetIsReadOnly(true);                                                   //필름유형
            grdToolMoveList.View.AddTextBoxColumn("FILMDETAILCATEGORYID")
                .SetIsHidden();                                                         //상세유형아이디
            grdToolMoveList.View.AddTextBoxColumn("FILMDETAILCATEGORY", 150)
                .SetIsReadOnly(true);                                                   //상세유형
            grdToolMoveList.View.AddTextBoxColumn("FILMUSELAYER1", 100)
                .SetIsReadOnly(true);                                                   //Layer
            grdToolMoveList.View.AddTextBoxColumn("FILMUSELAYER2", 120)
                .SetIsReadOnly(true);                                                   //Layer
            grdToolMoveList.View.AddTextBoxColumn("RESOLUTION", 100)
                .SetIsReadOnly(true);                                                   //해상도
            grdToolMoveList.View.AddTextBoxColumn("ISCOATING", 100)
                .SetIsReadOnly(true);                                                   //코팅유무
            grdToolMoveList.View.AddTextBoxColumn("MAKEVENDORID")
                .SetIsHidden();                                                         //제작업체아이디
            grdToolMoveList.View.AddTextBoxColumn("MAKEVENDOR", 150)
                .SetIsHidden()
                .SetIsReadOnly(true);                                                   //제작업체
            grdToolMoveList.View.AddTextBoxColumn("ISUPDATE")
                .SetIsHidden();                                                         //업데이트여부
        ...
        #region ConditionPlant_EditValueChanged - Site 조회조건의 변경이벤트
        ...
        #region grdToolMoveList_MouseUp - 마우스커서가 그리드의 헤더부분에 위치했을떄의 이벤트
        ...
        #region BtnSave_Click - 저장버튼 클릭이벤트
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable toolMoveList = SqlExecuter.Query("GetMoveFilmListForFilmReceiptByTool", "10001", values);
        ...
        {
            receiptUserCondition = Conditions.AddSelectPopup("USERNAME", new SqlQuery("GetUserListByTool", "10001", $"LANGUAGETYPE={ UserInfo.Current.LanguageType }", $"ENTERPRISEID={UserInfo.Current.Enterprise}", $"PLANTID={UserInfo.Current.Plant}"))
        ...
        #region ValidateContent - 전체 Validation을 진행한다.
        private bool ValidateContent(out string messageCode)
        {
            messageCode = "ToolMakeReceiptValidation";

            DataTable inputTable = grdToolMoveList.View.GetCheckedRows();

            foreach(DataRow inputRow in inputTable.Rows)
            {
                if(inputRow.GetString("ISMODIFY").Equals("N"))
                {
                    messageCode = "ValidateReceiptAreaRequiredSec";//입고할 작업장에 대한 권한이 없습니다.
                    return false;
                }
            }
        ...
        #region ValidateComboBoxEqualValue - 2개의 콤보박스의 값을 비교한다.
        ...
        #region ValidateNumericBox - 숫자형 텍스트 박스의 값을 검증한다.
        ...
        #region ValidateEditValue - 특정 값의 Validation
                ...
                if (grdToolMoveList.View.GetCheckedRows().Rows.Count > 0)
                {
                    ...
                    if (ValidateContent(out messageCode))
                    {
                        ...
                        foreach (DataRow inputRow in inputTable.Rows)
                        {
                            ...
                            moveRow["TOOLNUMBER"] = inputRow.GetString("FILMNO");
        ...
        private void ChangeSiteCondition()
        {
            ...
            if (sendAreaCondition != null)
                sendAreaCondition.SearchQuery = new SqlQuery("GetSendAreaListByTool", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}", $"ENTERPRISEID={UserInfo.Current.Enterprise}", $"PLANTID={Conditions.GetValue("P_PLANTID")}", $"CURRENTLOGINID={UserInfo.Current.Id}");
