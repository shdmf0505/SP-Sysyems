...
{
    /// <summary>
    /// 프 로 그 램 명  : 치공구관리 > 필름관리 > 필름제작요청 (새버전 - 인터플렉스)
    /// 업  무  설  명  : 초안작성 - 필름제작요청
    /// 생    성    자  : 김용조
    /// 생    성    일  : 2020-01-02
    /// 수  정  이  력  : 
    ...
    /// 
    /// </summary>
    public partial class NewRequestMakeFilmVerINTER : SmartConditionManualBaseForm
    {
        ...
        public NewRequestMakeFilmVerINTER()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO : 그리드 초기화 로직 추가
            grdFilm.GridButtonItem = GridButtonItem.Expand | GridButtonItem.Export | GridButtonItem.Restore;  // 행추가, 행삭제, 엑셀 내보내기, 엑셀 가져오기            
            ...
            grdFilm.View.AddTextBoxColumn("PRODUCTDEFVERSION", 80);                                  //품목버전
            grdFilm.View.AddTextBoxColumn("JOBTYPEID", 80).SetIsHidden();                            //작업구분아이디
            grdFilm.View.AddTextBoxColumn("JOBTYPE", 100)
            ...
            grdFilm.View.AddTextBoxColumn("FILMTYPE", 80)                                            //필름구분
                .SetTextAlignment(TextAlignment.Center)
                ;
            grdFilm.View.AddTextBoxColumn("FILMCATEGORYID").SetIsHidden();                           //필름유형아이디
            grdFilm.View.AddTextBoxColumn("FILMCATEGORY", 80)                                        //필름유형
                .SetTextAlignment(TextAlignment.Center)
                ;
            grdFilm.View.AddTextBoxColumn("FILMDETAILCATEGORYID").SetIsHidden();                     //상세유형아이디
            grdFilm.View.AddTextBoxColumn("FILMDETAILCATEGORY", 80)                                  //상세유형
                .SetTextAlignment(TextAlignment.Center)
                ;
            grdFilm.View.AddTextBoxColumn("FILMUSELAYER1", 120);                                     //Layer1          
            grdFilm.View.AddTextBoxColumn("FILMUSELAYER2", 150);                                     //Layer2          
            grdFilm.View.AddTextBoxColumn("CUSTOMERID").SetIsHidden();                               //고객사아이디
            grdFilm.View.AddTextBoxColumn("CUSTOMER", 120);                                          //고객사
            grdFilm.View.AddTextBoxColumn("USEPROCESSSEGMENT", 80).SetIsHidden();                    //사용공정
            grdFilm.View.AddTextBoxColumn("RESOLUTION", 80);                                         //해상도
            grdFilm.View.AddTextBoxColumn("ISCOATING", 80)                                           //코팅유무
                .SetTextAlignment(TextAlignment.Center)
                ;
            grdFilm.View.AddTextBoxColumn("CONTRACTIONX", 120);                                      //요청수출율X
            grdFilm.View.AddTextBoxColumn("CONTRACTIONY", 120);                                      //요청수축율Y
            grdFilm.View.AddTextBoxColumn("CHANGECONTRACTIONX", 120);                                //요청수축율(%)X
            grdFilm.View.AddTextBoxColumn("CHANGECONTRACTIONY", 120);                                //요청수축율(%)Y
            ...
            grdFilm.View.AddTextBoxColumn("PRIORITY", 80)                                            //우선순위
                .SetTextAlignment(TextAlignment.Center)
                ;
            ...
            grdFilm.View.AddTextBoxColumn("REQUESTCOMMENT", 200);                                    //요청내용
            grdFilm.View.AddTextBoxColumn("ACCEPTDATE", 160)
            ...
            grdFilm.View.AddTextBoxColumn("RELEASEDATE", 160)
            ...
            grdFilm.View.AddTextBoxColumn("RECEIVEDATE", 160)
                .SetDisplayFormat("yyyy-MM-dd HH:mm:ss")
                .SetIsHidden();                                                                      //인수일시
        ...
        {   
            ...
            //grdActionFilm.View.SetIsReadOnly();
            ...
            grdActionFilm.View.AddTextBoxColumn("FILMPROGRESSSTATUS", 80)
                .SetTextAlignment(TextAlignment.Center)
                .SetIsReadOnly(true)
                ;                                                                                           //진행상태                        
            grdActionFilm.View.AddTextBoxColumn("FILMCODE", 150).SetIsHidden();                             //필름코드                                           
            grdActionFilm.View.AddTextBoxColumn("FILMVERSION", 120)
            ...
            grdActionFilm.View.AddComboBoxColumn("FILMCATEGORY", 120, new SqlQuery("GetCodeListByFilm", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}", $"CODECLASSID=ToolTypeA"), "CODENAME", "CODEID")
                .SetTextAlignment(TextAlignment.Center)                                                     //필름유형
                .SetValidationIsRequired()
                ;
            grdActionFilm.View.AddTextBoxColumn("FILMDETAILCATEGORY", 150)
                .SetValidationIsRequired()
                ;                                                                                           //상세유형          

            //grdActionFilm.View.AddComboBoxColumn("FILMUSELAYER1", 100, new SqlQuery("GetCodeListByFilm", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}", $"CODECLASSID=FilmUseLayer1"), "CODENAME", "CODEID")
            //    .SetTextAlignment(TextAlignment.Center)                                                     //Layer1
            //    .SetEmptyItem("", "", true)
            //    ;
            grdActionFilm.View.AddTextBoxColumn("FILMUSELAYER1", 120)                                       //Layer1
                ;
            grdActionFilm.View.AddTextBoxColumn("FILMUSELAYER2", 120)                
                ;                                                                                           //Layer2            
            ...
            grdActionFilm.View.AddComboBoxColumn("ISCOATING", 80, new SqlQuery("GetCodeListByToolWithLanguage", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}", $"CODECLASSID=YesNo"), "CODENAME", "CODEID")                
                ...
                ;
            grdActionFilm.View.AddSpinEditColumn("CONTRACTIONX", 100)                                       //요청수출율X
                .SetDisplayFormat("0.#####")
                .IsFloatValue = true
                ;                                      
            grdActionFilm.View.AddSpinEditColumn("CONTRACTIONY", 100)                                       //요청수축율Y
                .SetDisplayFormat("0.#####")
                .IsFloatValue = true
                ;                                      
            grdActionFilm.View.AddTextBoxColumn("CHANGECONTRACTIONX", 80)                                  //요청수축율(%)X
                .SetIsReadOnly()
                ;                                
            grdActionFilm.View.AddTextBoxColumn("CHANGECONTRACTIONY", 80)                                  //요청수축율(%)Y
                .SetIsReadOnly()
                ;                                
            
            grdActionFilm.View.AddDateEditColumn("USEPLANDATE", 120)
            ...
            grdActionFilm.View.AddSpinEditColumn("QTY", 80)                                                 //수량
                .SetValidationIsRequired()
                ;
        ...
        private bool ValidateCurrentDeleteStatus(DataRow currentRow, out string messageCode)
        {
            ...
            if (!currentRow.GetString("FILMPROGRESSSTATUSID").Equals("CancelAccept"))
            {
                messageCode = "ValidateFilmDeleteWithCancel"; //ValidateFilmDeleteWithCancel 접수취소상태만 삭제할 수 있습니다.
                return false;
            }
                ...
                if (grdActionFilm.View.RowCount > 0)
                {
                    ...
                    if (ValidateCurrentStatus("Request", out messageCode))
                    {
                        ...
                        foreach (DataRow actionRow in actionTable.Rows)
                        {
                            ...
                            //if (actionRow.GetString("_STATE_").Equals("added"))
                            //{
        ...
        private void DisplayInfoDetail(DataRow filmInfo)
        {
            ...
            else
            {
                ...
                if (pnlToolbar.Controls["layoutToolbar"].Controls["RequestAgain"] != null && pnlToolbar.Controls["layoutToolbar"].Controls["RequestAgain"].Visible == true)
                    pnlToolbar.Controls["layoutToolbar"].Controls["RequestAgain"].Visible = false;
                if (pnlToolbar.Controls["layoutToolbar"].Controls["Delete"] != null && pnlToolbar.Controls["layoutToolbar"].Controls["Delete"].Visible == true)
                    pnlToolbar.Controls["layoutToolbar"].Controls["Delete"].Visible = false;
                if (pnlToolbar.Controls["layoutToolbar"].Controls["Copy"] != null && pnlToolbar.Controls["layoutToolbar"].Controls["Copy"].Visible == true)
        ...
        private void LoadData(DataTable checkedTable)
        {
            ...
            foreach (DataRow checkedRow in checkedTable.Rows)
            {
                ...
                grdActionFilm.View.SetRowCellValue(rowHandle, "FILMVERSION", GetNewVersion(grdProduct.GetFieldValue("PRODUCTDEFID").ToString(), grdProduct.GetFieldValue("PRODUCTDEFVERSION").ToString()));
            ...
            try
            {
                foreach (DataRow subRow in ruleTable.Rows)
                {
                    if (newRow.GetString("FILMVERSION").Equals(subRow.GetString("FILMVERSION"))
                        ...
                        && newRow.GetString("LAYER1").Equals(subRow.GetString("LAYER1"))
                        && newRow.GetString("LAYER2").Equals(subRow.GetString("LAYER2"))
                        )
                        return false;
                }
                return true;
