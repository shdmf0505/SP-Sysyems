...
namespace Micube.SmartMES.MaterialsManagement.Popup
{
    ...
    /// 
    /// </summary>
    public partial class MaterialOtherGoodsReceiptPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        #region 생성자
        public MaterialOtherGoodsReceiptPopup()
        {
            InitializeComponent();
        ...
        public MaterialOtherGoodsReceiptPopup(string SPlantid, string SAreaid, string SAreaName)
        {
            InitializeComponent();
        ...
        private void SearchReceiptPopup()
        {
            ...
            if (!dtpEndDate.Text.Equals(""))
            {
                ...
                DateTime dtEnddat = Convert.ToDateTime(dtpEndDate.EditValue.ToString());
            ...
            DataTable dtReceipt = SqlExecuter.Query("GetMaterialOtherGoodsReceiptPopup", "10001", Param);
        ...
        private void InitializeGrid()
        {
            ...
            grdMaterialReceiptPopup.View.AddTextBoxColumn("PLANTID", 150)
                .SetIsHidden();
            grdMaterialReceiptPopup.View.AddTextBoxColumn("TRANSACTIONNO", 120);
            grdMaterialReceiptPopup.View.AddTextBoxColumn("TRANSACTIONDATE", 150)
