...
{
    /// <summary>
    /// 프 로 그 램 명  : 자재 반납 등록popup
    /// 업  무  설  명  : 자재 반납 등록 리스트 조히 
    /// 생    성    자  : 최별
    /// 생    성    일  : 2019-08-05
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class MaterialGoodsReturnPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        #region 생성자
        public MaterialGoodsReturnPopup()
        {
            InitializeComponent();
        ...
        public MaterialGoodsReturnPopup(string SPlantid, string SAreaid, string SAreaName)
        {
            InitializeComponent();
        ...
        private void SearchReceiptPopup()
        {
            ...
            DataTable dtReceipt = SqlExecuter.Query("GetMaterialGoodsReturnPopup", "10001", Param);
        ...
        private void InitializeGrid()
        {
            ...
            grdMaterialReceiptPopup.View.AddTextBoxColumn("PLANTID", 150)
                .SetIsHidden();
            grdMaterialReceiptPopup.View.AddTextBoxColumn("TRANSACTIONNORETURN", 120);
            grdMaterialReceiptPopup.View.AddTextBoxColumn("TRANSACTIONDATERETURN", 150)
