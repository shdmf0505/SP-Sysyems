...
{
    /// <summary>
    /// 프 로 그 램 명  :자재 재고 조정popup
    /// 업  무  설  명  : 자재 재고 조정 리스트 조히 
    /// 생    성    자  : 최별
    /// 생    성    일  : 2019-08-05
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class MaterialInventorySplitPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        #region 생성자
        public MaterialInventorySplitPopup()
        {
            InitializeComponent();
        ...
        public MaterialInventorySplitPopup(string SPlantid, string SAreaid, string SAreaName)
        {
            InitializeComponent();
        ...
        private void SearchReceiptPopup()
        {
            ...
            DataTable dtReceipt = SqlExecuter.Query("GetMaterialInventorySplitPopup", "10001", Param);
        ...
        private void InitializeGrid()
        {
            ...
            grdMaterialReceiptPopup.View.AddTextBoxColumn("TRANSACTIONDATEISSUE", 150)
            ...
            grdMaterialReceiptPopup.View.AddTextBoxColumn("CONSUMABLELOTID", 150);
            grdMaterialReceiptPopup.View.AddTextBoxColumn("RELCONSUMABLELOTID", 150);
            ...
            grdMaterialReceiptPopup.View.AddSpinEditColumn("QTY", 150)
