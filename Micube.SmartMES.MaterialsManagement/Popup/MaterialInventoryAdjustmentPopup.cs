...
namespace Micube.SmartMES.MaterialsManagement.Popup
{
    ...
    /// 
    /// </summary>
    public partial class MaterialInventoryAdjustmentPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        #region 생성자
        public MaterialInventoryAdjustmentPopup()
        {
            InitializeComponent();
        ...
        public MaterialInventoryAdjustmentPopup(string SPlantid, string SAreaid, string SAreaName)
        {
            InitializeComponent();
        ...
        private void SearchReceiptPopup()
        {
            ...
            DataTable dtReceipt = SqlExecuter.Query("GetMaterialInventoryAdjustmentPopup", "10001", Param);
