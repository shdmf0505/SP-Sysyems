...
namespace Micube.SmartMES.MaterialsManagement
{
    ...
    /// 
    /// </summary>
    public partial class MaterialInventoryAdjustment : SmartConditionManualBaseForm
    {
        ...
        public MaterialInventoryAdjustment()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdMaterial.View.AddSpinEditColumn("QTY", 100)
                ...
                .SetDisplayFormat("#,###,##0.#####", MaskTypes.Numeric)
                 .SetTextAlignment(TextAlignment.Right)
                  .IsFloatValue = true;
            grdMaterial.View.AddSpinEditColumn("ADJSTOCKQTY", 150)
                .SetTextAlignment(TextAlignment.Right)
                .SetDisplayFormat("#,###,##0.#####", MaskTypes.Numeric)
                .SetIsReadOnly(); 
            ...
            {
                InitializeGrid_CostcentercodePopup();
                grdMaterial.View.AddTextBoxColumn("COSTCENTERNAME", 100)
                .SetIsReadOnly();
        ...
        {
            var popupGridConsumabledefid = this.grdMaterial.View.AddSelectPopupColumn("CONSUMABLEDEFID",120, new SqlQuery("GetConsumabledefinitionStockQtyOnlyListByCsm", "10001", $"P_QTYZEROCHECK={"N"}"))
                // 팝업 폼 타이틀(다국어 키 입력), 버튼 유형, 검색 버튼 활성화 여부, 자동 검색 여부
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
           ...
           // if (_strDateChangeAuth == "true")
            ...
            for (int i = 0; i < grdMaterial.View.DataRowCount; i++)
            {
                ...
                if (UserInfo.Current.Enterprise.Equals("YOUNGPOONG"))
                {
                    string strCostcentercode = grdMaterial.View.GetRowCellValue(i, "COSTCENTERCODE").ToString();
                    if (strCostcentercode.Equals(""))
                    {
                        string lblTransactionreasoncode = grdMaterial.View.Columns["COSTCENTERCODE"].Caption.ToString();
                        this.ShowMessage(MessageBoxButtons.OK, "InValidOspRequiredField", lblTransactionreasoncode); //메세지
                        return;
                    }
                }
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                try
                {
                    ...
                    DataTable saveResult = this.ExecuteRule<DataTable>("MaterialInventoryAdjustment", ds);
        ...
        private void View_AddingNewRow(Framework.SmartControls.Grid.BandedGrid.SmartBandedGridView sender, Framework.SmartControls.Grid.AddNewRowArgs args)
        {
            ...
            grdMaterial.View.SetFocusedRowCellValue("TRANSACTIONTYPE", "Adjust");
            grdMaterial.View.SetFocusedRowCellValue("TRANSACTIONCODE", "MISC_ISSUE");
        ...
        private void PopupShow()
        {
            ...
            MaterialInventoryAdjustmentPopup ReceiptPopup = new MaterialInventoryAdjustmentPopup(sPlantid, sAreaid, sAreaName);
        ...
        private void OnSaveConfrimSearch(string workgubun, string sPlantid, string sTransActionNo, string sTransactionDate)
        {
            ...
            Param.Add("P_TRANSACTIONTYPE", "Adjust");
            Param.Add("P_TRANSACTIONCODE", "MISC_ISSUE");
