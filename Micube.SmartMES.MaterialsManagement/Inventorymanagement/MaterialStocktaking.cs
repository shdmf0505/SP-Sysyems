...
namespace Micube.SmartMES.MaterialsManagement
{
    ...
    /// 
    /// </summary>
    public partial class MaterialStocktaking : SmartConditionManualBaseForm
    {
       // private IContainer components;
        ...
        private void InitializeGrid()
        {
            ...
            grdMaterialStatistics.View.AddTextBoxColumn("BASEMONTH", 160).SetIsHidden();
            ...
            grdMaterialStatistics.View.AddSpinEditColumn("STOCKQTY", 120)
                .SetDisplayFormat("#,###,###,##0.#####")
                .SetIsReadOnly(true);                                                  //상태            
            grdMaterialStatistics.View.AddSpinEditColumn("CYCLECOUNT", 120)
                .SetDisplayFormat("#,###,###,##0.#####")
                .SetIsReadOnly(true);                                                  //상태            
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable stockTable = SqlExecuter.Query("GetMaterialStockTakingList", "10001", values);
        ...
        private void btnWipPhysicalList_Click(object sender, EventArgs e)
        {
            ...
            DataTable lotList = grdMaterialStatistics.DataSource as DataTable;

            //lotList.AsEnumerable().ForEach(row =>
            //{
            //    row["STOCKQTY"] = DBNull.Value;
            //    //row["CYCLECOUNT"] = DBNull.Value;
            ...
            Stream stream = assembly.GetManifestResourceStream("Micube.SmartMES.MaterialsManagement.ReportCsm.MaterialStocktakingList.repx");
            Commons.CommonFunction.PrintMaterialStocktakingList(stream, dt);
