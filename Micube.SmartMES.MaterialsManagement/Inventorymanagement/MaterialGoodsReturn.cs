...
{
    /// <summary>
    /// 프 로 그 램 명  : 자재관리 > 자재재고관리 > 자재 반납 등록
    /// 업  무  설  명  : 자재 반납 등록를 관리한다.
    /// 생    성    자  : 최별
    /// 생    성    일  : 2019-07-30
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class MaterialGoodsReturn : SmartConditionManualBaseForm
    {
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                try
                {
                    ...
                    DataTable saveResult = this.ExecuteRule<DataTable>("MaterialGoodsReturn", ds);
        ...
        private void View_AddingNewRow(Framework.SmartControls.Grid.BandedGrid.SmartBandedGridView sender, Framework.SmartControls.Grid.AddNewRowArgs args)
        {
            ...
            grdMaterial.View.SetFocusedRowCellValue("TRANSACTIONTYPE", "Return");
        ...
        private void PopupShow()
        {
            ...
            MaterialGoodsReturnPopup ReceiptPopup = new MaterialGoodsReturnPopup(sPlantid, sAreaid, sAreaName);
        ...
        private void ReceiptPopup_write_handler(DataRow row)
        {
            ...
            {
                popupOspAreaid.EditValueChanged -= popupOspAreaid_EditValueChanged;
                OnSaveConfrimSearch("Search", row["PLANTID"].ToString(), row["TRANSACTIONNORETURN"].ToString(), row["TRANSACTIONDATERETURN"].ToString());
        ...
        private void OnSaveConfrimSearch(string workgubun, string sPlantid, string sTransActionNo, string sTransactionDate)
        {
            ...
            Param.Add("P_TRANSACTIONTYPE", "Return");
