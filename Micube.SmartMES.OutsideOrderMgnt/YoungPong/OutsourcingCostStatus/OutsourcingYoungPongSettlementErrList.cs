    ...
    public partial class OutsourcingYoungPongSettlementErrList : SmartConditionManualBaseForm
    {
        ...
        private void InitializeGrid_Master()
        {
            ...
            costtotlotprd.AddTextBoxColumn("OSPPRODUCTIONPCSQTY", 120)
              ...
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotprd.AddTextBoxColumn("OSPPRODUCTIONM2QTY", 120)
              .SetLabel("M2")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0.####", MaskTypes.Numeric);
            ...
            costtotlotsim.AddTextBoxColumn("OSPSAMPLEPCSQTY", 120)
              ...
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsim.AddTextBoxColumn("OSPSAMPLEM2QTY", 120)
              .SetLabel("M2")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0.####", MaskTypes.Numeric);
        ...
        {
            if (!string.IsNullOrWhiteSpace(grdMaster.View.ActiveFilterString))
            {
                int rowHandle = grdMaster.View.FocusedRowHandle;

                if (currentRowHandle == rowHandle)
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                try
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        // 속도 문제로 인해 한번에 처리하는 LOT 수를 제한
                        int MAX_PROCESSING_LOTS = 100;
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable dtSearchMaster = await SqlExecuter.QueryAsync("GetOutsourcingYoungPongSettlementErrMaster", "10001", values);
