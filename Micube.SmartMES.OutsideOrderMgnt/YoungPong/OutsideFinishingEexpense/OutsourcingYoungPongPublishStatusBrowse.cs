...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongPublishStatusBrowse : SmartConditionManualBaseForm
    {
        ...
        public OutsourcingYoungPongPublishStatusBrowse()
        {
            InitializeComponent();
        }
        ...
        {
            grdDetailInfo.View.Columns["PRODUCTDEFNAME"].SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            grdDetailInfo.View.Columns["PRODUCTDEFNAME"].SummaryItem.DisplayFormat = string.Format("{0}", Language.Get("SUM"));
            grdDetailInfo.View.Columns["SETTLEAMOUNT"].SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            grdDetailInfo.View.Columns["SETTLEAMOUNT"].SummaryItem.DisplayFormat = "{0:###,###}";
            

            grdDetailInfo.View.OptionsView.ShowFooter = true;
            grdDetailInfo.ShowStatusBar = false;
        }
        #endregion
        ...
        private void InitializeVendorInfoGrid()
        {
            ...
            grdVendorInfo.View.Columns["OSPETCTYPENAME"].SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            grdVendorInfo.View.Columns["OSPETCTYPENAME"].SummaryItem.DisplayFormat = string.Format("{0}", Language.Get("SUM"));
            grdVendorInfo.View.Columns["TODAYAMOUNT"].SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            grdVendorInfo.View.Columns["TODAYAMOUNT"].SummaryItem.DisplayFormat = "{0:###,###}";
            grdVendorInfo.View.Columns["SETTLEAMOUNT"].SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.Sum;
            grdVendorInfo.View.Columns["SETTLEAMOUNT"].SummaryItem.DisplayFormat = "{0:###,###}";

            grdVendorInfo.View.OptionsView.ShowFooter = true;
            grdVendorInfo.ShowStatusBar = false;
        }
        #endregion
        #endregion
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable vendorTable = SqlExecuter.Query("GetOutsourcingYoungPongPublishStatusBrowseMaster", "10001", values);

            grdVendorInfo.DataSource = vendorTable;

            DataTable detailTable = SqlExecuter.Query("GetOutsourcingYoungPongPublishStatusBrowseDetail", "10001", values);
