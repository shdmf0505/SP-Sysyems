...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongFixedRateDownPrice : SmartConditionBaseForm
    {
        ...
        public OutsourcingYoungPongFixedRateDownPrice()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdFixedRate.View.AddTextBoxColumn("PRICECLASSNAME", 150);
            grdFixedRate.View.AddTextBoxColumn("OSPPRICECODE", 100); //           --외주단가코드
            grdFixedRate.View.AddTextBoxColumn("OSPPRICENAME", 150); //--외주단가명
            grdFixedRate.View.AddComboBoxColumn("OSPPRODUCTIONTYPE", 100, new SqlQuery("GetCodeList", "00001", "CODECLASSID=OSPProductionType", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"))
            ...
            grdFixedRate.View.AddTextBoxColumn("OSPPRICESTAND", 250);
            grdFixedRate.View.AddTextBoxColumn("OSPVENDORID", 120).SetIsHidden();
            grdFixedRate.View.AddTextBoxColumn("OSPVENDORNAME", 120); //

            grdFixedRate.View.AddComboBoxColumn("PRICEUNIT", 100, new SqlQuery("GetUomDefinitionMapListByOsp", "10001", "UOMCATEGORY=OSP", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"), "UOMDEFID", "UOMDEFID")
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable dtSpecial = await SqlExecuter.QueryAsync("GetOutsourcingYoungPongFixedRateDownPrice", "10001", values);
        ...
        {
            var txtOsppricecode = Conditions.AddSelectPopup("p_osppricecode", new SqlQuery("GetOsppricecodeListByOspYp", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"), "OSPPRICENAME", "OSPPRICECODE")
        ...
        private void InitializeConditionPopup_ProductionType()
        {
            ...
            var owntypecbobox = Conditions.AddComboBox("p_OSPPRODUCTIONTYPE", new SqlQuery("GetCodeAllListByOspPrice", "10001", "CODECLASSID=OSPProductionType", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"))
               .SetLabel("PRODUCTIONTYPE")
               .SetMultiColumns(ComboBoxColumnShowType.DisplayMemberAndValueMember, false)
               .SetPosition(2.1)
               .SetEmptyItem("", "")
        ...
        private DataTable createSaveDatatable()
        {
            ...
            dt.Columns.Add("OSPPRODUCTIONTYPE");
        ...
        private void ProcSave(string strtitle)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                try
                {
                    ...
                    drSave["OSPPRICECODE"] = values["P_OSPPRICECODE"].ToString();
                    drSave["PROCESSSEGMENTCLASSID"] = values["P_PROCESSSEGMENTCLASSID"].ToString();
                    drSave["PROCESSSEGMENTID"] = "*";
                    drSave["PROCESSPRICETYPE"] = "*";
                    drSave["OWNTYPE"] = "*";
                    drSave["PRODUCTDEFVERSION"] = values["P_PRODUCTDEFVERSION"].ToString();
                    drSave["PRODUCTDEFID"] = values["P_PRODUCTDEFID"].ToString();
                    drSave["OSPVENDORID"] = values["P_OSPVENDORID"].ToString();
                    drSave["OSPPRODUCTIONTYPE"] = values["P_OSPPRODUCTIONTYPE"].ToString();
                    drSave["PRICECHANGETYPE"] = cboPricechangetype.EditValue.ToString();
                    drSave["CHANGERATE"] = txtChangerate.EditValue.ToString();
                    drSave["DECIMALPLACE"] = cboDecimalplace.EditValue.ToString();
                    drSave["CALCULATEDECIAMLPOINTTYPE"] = cboCalculatedeciamlpointtype.EditValue.ToString();
                    ...
                    ExecuteRule("OutsourcingYoungPongFixedRateDownPrice", dtSave);
        ...
        private void OnSaveConfrimSearch()
        {
            ...
            #endregion
            values = Commons.CommonFunction.ConvertParameter(values);
            DataTable dtSpecial = SqlExecuter.Query("GetOutsourcingYoungPongFixedRateDownPrice", "10001", values);
