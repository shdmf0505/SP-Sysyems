...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongPriceCodeTemp : SmartConditionManualBaseForm
    {
        ...
        public OutsourcingYoungPongPriceCodeTemp()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid_Detail()
        {
            ...
            grdDetail.View.SetKeyColumn("PLANTID", "OSPPRICECODE", "PRICECLASSID");
        ...
        public void InitializeEvent()
        {
            ...
            grdTab2Master.View.AddingNewRow += GrdTab2Master_AddingNewRow;
        ...
        private void focusedRowChangedMaster()
        {
            ...
            if (dtDetail.Rows.Count < 1)
            {
                ...
                grdTab2Master.View.ClearColumns();
                grdTab1Detail.View.ClearColumns();
                grdTab2Detail.View.ClearColumns();
            }
            else
            {
        ...
        private void focusedRowChangedDetail()
        {
            ...
            grdTab1Master.View.ClearColumns();
            InitializeGrid_GrdTab1MasterDisplay("N");
        ...
        private bool ProcSaveCheck()
        {
            ...
            {
                grdTab2Master.View.FocusedRowHandle = grdTab1Master.View.FocusedRowHandle;
        ...
        private void ProcSave(string strtitle)
        {
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                try
                {
                    ...
                    DataTable dtSaveTab1Detail = null;

                    if (tabCom.SelectedTabPage.Name.Equals("tabProcesssegment"))
                    {
                        dtSaveTab1Master = grdTab1Master.GetChangedRows();
                        dtSaveTab1Detail = grdTab1Detail.GetChangedRows();
                    }
                    else
                    {
                        dtSaveTab1Master = grdTab1Master.GetChangedRows();
