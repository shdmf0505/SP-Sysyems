...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongSpecialPriceInquiry : SmartConditionManualBaseForm
    {
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable specialAmountTable = SqlExecuter.Query("GetOutsourcingYoungPongSpecialPriceInquery", "10001", values);
