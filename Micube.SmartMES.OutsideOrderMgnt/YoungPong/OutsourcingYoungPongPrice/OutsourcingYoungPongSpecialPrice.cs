...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongSpecialPrice : SmartConditionBaseForm
    {
        ...
        public OutsourcingYoungPongSpecialPrice()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdSpecial.View.AddTextBoxColumn("ENTERPRISEID", 200)
                .SetIsHidden();                                                      //  공장 ID
            grdSpecial.View.AddTextBoxColumn("PRODUCTDEFID", 200).SetIsHidden();
            grdSpecial.View.AddTextBoxColumn("PRODUCTDEFVERSION", 200).SetIsHidden();
            grdSpecial.View.AddTextBoxColumn("AREAID", 200).SetIsHidden();
            InitializeGrid_ProcesssegmentidListPopup(); //공정코드
            grdSpecial.View.AddTextBoxColumn("PROCESSSEGMENTNAME", 200)
                .SetIsReadOnly();
            InitializeGrid_OspVendoridListPopup();//협력사
            grdSpecial.View.AddTextBoxColumn("OSPVENDORNAME", 200)
                .SetIsReadOnly();
            grdSpecial.View.AddTextBoxColumn("MODELID", 100);
            ...
            grdSpecial.View.AddTextBoxColumn("REDUCERATE", 100)
                .SetValidationIsRequired()
            ...
            grdSpecial.View.SetKeyColumn("PLANTID", "ENTERPRISEID", "STARTDATE", "PROCESSSEGMENTID", "OSPVENDORID", "MODELID");
            ...
            grdSpecial.View.Columns["REDUCERATE"].ColumnEdit = edit;
        }
        ...
        private void View_AddingNewRow(Framework.SmartControls.Grid.BandedGrid.SmartBandedGridView sender, Framework.SmartControls.Grid.AddNewRowArgs args)
        {
            ...
            grdSpecial.View.SetFocusedRowCellValue("OSPVENDORNAME", "*");// 
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable dtSpecial = await SqlExecuter.QueryAsync("GetOutsourcedYoungPongSpecialPrice", "10001", values);
        ...
        protected override void InitializeCondition()
        {
            ...
            InitializeConditionPopup_ModelId();
            //site
            //공정
            //협력사
            //품목코드
        ...
        private void InitializeConditionPopup_ModelId()
        {
           
            var txtOspVendor = Conditions.AddTextBox("P_Modelid")
               .SetLabel("MODELID")
               .SetPosition(3.1);
        ...
        private void OnSaveConfrimSearch()
        {
            ...
            #endregion
            values = Commons.CommonFunction.ConvertParameter(values);
            DataTable dtSpecial = SqlExecuter.Query("GetOutsourcedYoungPongSpecialPrice", "10001", values);
