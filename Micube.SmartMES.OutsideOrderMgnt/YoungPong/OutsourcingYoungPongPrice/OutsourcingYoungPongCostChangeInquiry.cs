...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongCostChangeInquiry : SmartConditionManualBaseForm
    {
        ...
        public OutsourcingYoungPongCostChangeInquiry()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdSearch.View.AddTextBoxColumn("PRICECLASSNAME", 150);
            grdSearch.View.AddTextBoxColumn("OSPPRICECODE", 100);
            grdSearch.View.AddTextBoxColumn("OSPPRICENAME", 150);
            grdSearch.View.AddComboBoxColumn("OSPPRODUCTIONTYPE", 100, new SqlQuery("GetCodeAllListByOspPrice", "10001", "CODECLASSID=OSPProductionType", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"))
            ...
            grdSearch.View.AddTextBoxColumn("OSPPRICESTAND", 250);
            grdSearch.View.AddTextBoxColumn("OSPVENDORNAME", 100).SetIsReadOnly();
            grdSearch.View.AddComboBoxColumn("PRICEUNIT", 100, new SqlQuery("GetUomDefinitionMapListByOsp", "10001", "UOMCATEGORY=OSP", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"), "UOMDEFID", "UOMDEFID")
                .SetDefault("");
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable dtSearch = await SqlExecuter.QueryAsync("GetOutsourcingYoungPongCostChangeInquiry", "10001", values);
