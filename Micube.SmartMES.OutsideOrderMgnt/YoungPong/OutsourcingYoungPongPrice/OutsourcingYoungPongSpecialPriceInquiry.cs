...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingYoungPongSpecialPriceInquiry : SmartConditionBaseForm
    {
        ...
        public OutsourcingYoungPongSpecialPriceInquiry()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdSpecialAmount.View.AddTextBoxColumn("OSPVENDORID", 60).SetIsHidden();
            grdSpecialAmount.View.AddTextBoxColumn("OSPVENDORNAME", 120);
            grdSpecialAmount.View.AddTextBoxColumn("MODELID", 150);
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable specialAmountTable = SqlExecuter.Query("GetOutsourcingYoungPongSpecialPriceInquiry", "10001", values);
