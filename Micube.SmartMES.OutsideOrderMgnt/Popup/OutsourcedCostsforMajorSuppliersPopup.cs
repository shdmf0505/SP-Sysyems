...
namespace Micube.SmartMES.OutsideOrderMgnt.Popup
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcedCostsforMajorSuppliersPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        #region 생성자
        public OutsourcedCostsforMajorSuppliersPopup()
        {
            InitializeComponent();
        ...
        public OutsourcedCostsforMajorSuppliersPopup(string strperiodid, string strplantid, string strvendorid, string strAreaid, string strvendorname, string strAreaname, string strperiodname)
        {
            InitializeComponent();
