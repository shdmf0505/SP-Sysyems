...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingAmountStatusBrowse : SmartConditionManualBaseForm
    {
        ...
        public OutsourcingAmountStatusBrowse()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdOSAmount.View.AddTextBoxColumn("OSPVENDORID", 150)
                .SetIsHidden();
            grdOSAmount.View.AddTextBoxColumn("OSPVENDORNAME", 200);
            grdOSAmount.View.AddTextBoxColumn("AREAID", 150)
                .SetIsHidden();
            grdOSAmount.View.AddTextBoxColumn("AREANAME", 200);
            grdOSAmount.View.AddSpinEditColumn("PDAMOUNT", 150)
                .SetIsReadOnly(true);
            grdOSAmount.View.AddSpinEditColumn("SPAMOUNT", 150)
                .SetIsReadOnly(true);
            grdOSAmount.View.AddSpinEditColumn("OSPLOTTYPESMT", 150)
               .SetIsReadOnly(true);
            grdOSAmount.View.AddSpinEditColumn("OEWAMOUNT", 150)
                .SetIsReadOnly(true);
            grdOSAmount.View.AddSpinEditColumn("OEAAMOUNT", 150)
                .SetIsReadOnly(true);
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable amountTable = SqlExecuter.Query("GetOutsourcingAmountStatusByOsp", "10001", values);
        ...
        private void SearchDetailInfo()
        {
            if (grdOSAmount.View.FocusedRowHandle > -1)
            {
                ...
                values.Add("P_AREAID", currentRow.GetString("AREAID"));
