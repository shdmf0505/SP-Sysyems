...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcingProcessingCosts : SmartConditionManualBaseForm
    {
        ...
        public OutsourcingProcessingCosts()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGridProduct()
        {
            ...
            costprocess.AddTextBoxColumn("AREAID", 80);
            ...
            costtotlotsim.AddTextBoxColumn("OSPLOTTYPESIMCLAIM", 120)
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            var costtotlotSMT = grdOspProcProduct.View.AddGroupColumn("OSPLOTTYPESMT");
            costtotlotSMT.AddTextBoxColumn("OSPLOTTYPESMTPANELQTY", 120)
               .SetTextAlignment(TextAlignment.Right)
               .SetDisplayFormat("#,##0", MaskTypes.Numeric)
               .SetLabel("OSPLOTTYPESIMPANELQTY");
            costtotlotSMT.AddTextBoxColumn("OSPLOTTYPESMTPCSQTY", 120)
               .SetTextAlignment(TextAlignment.Right)
               .SetDisplayFormat("#,##0", MaskTypes.Numeric)
                .SetLabel("OSPLOTTYPESIMPCSQTY");
            costtotlotSMT.AddTextBoxColumn("OSPLOTTYPESMTMMQTY", 120)
               .SetTextAlignment(TextAlignment.Right)
               .SetDisplayFormat("#,##0", MaskTypes.Numeric)
                .SetLabel("OSPLOTTYPESIMMMQTY");
            costtotlotSMT.AddTextBoxColumn("OSPLOTTYPESMTAMOUNT", 120)
               .SetTextAlignment(TextAlignment.Right)
               .SetDisplayFormat("#,##0", MaskTypes.Numeric)
                .SetLabel("OSPLOTTYPESIMAMOUNT");
            costtotlotSMT.AddTextBoxColumn("OSPLOTTYPESMTETC", 120)
               .SetTextAlignment(TextAlignment.Right)
               .SetDisplayFormat("#,##0", MaskTypes.Numeric)
               .SetLabel("OSPLOTTYPESIMETC");
            costtotlotSMT.AddTextBoxColumn("OSPLOTTYPESMTCLAIM", 120)
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric)
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            {
                DataTable dt = await SqlExecuter.QueryAsync("GetOutsourcingProcessingCostsProduct", "10001", values);
            ...
            {
                DataTable dt = await SqlExecuter.QueryAsync("GetOutsourcingProcessingCostsLayer", "10001", values);
