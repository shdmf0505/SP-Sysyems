...
namespace Micube.SmartMES.OutsideOrderMgnt
{
    ...
    /// 
    /// </summary>
    public partial class OutsourcedSettlementErrList : SmartConditionManualBaseForm
    {
        ...
        public OutsourcedSettlementErrList()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid_Master()
        {
            ...
            costtotlotprd.AddTextBoxColumn("OSPPRODUCTIONCNT", 120)
              .SetLabel("OSPCLOSECOUNT")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotprd.AddTextBoxColumn("OSPPRODUCTIONPNLQTY", 120)
              .SetLabel("PNL")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotprd.AddTextBoxColumn("OSPPRODUCTIONPCSQTY", 120)
              .SetLabel("PCS")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotprd.AddTextBoxColumn("OSPPRODUCTIONDEFECTQTY", 120)
              .SetLabel("DEFECT")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            ...
            costtotlotsim.AddTextBoxColumn("OSPSAMPLECNT", 120)
              .SetLabel("OSPCLOSECOUNT")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsim.AddTextBoxColumn("OSPSAMPLEPNLQTY", 120)
              .SetLabel("PNL")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsim.AddTextBoxColumn("OSPSAMPLEPCSQTY", 120)
              .SetLabel("PCS")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsim.AddTextBoxColumn("OSPSAMPLEDEFECTQTY", 120)
              .SetLabel("DEFECT")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            ...
            costtotlotsim.AddTextBoxColumn("OSPSAMPLESETTLEAMOUNT", 120)
              ...
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            //양산(pnl,pcs,mm ,외주비 ,기타외주비 )
            var costtotlotsmt = grdMaster.View.AddGroupColumn("OSPLOTTYPESMT");

            costtotlotsmt.AddTextBoxColumn("OSPSMTCNT", 120)
              .SetLabel("OSPCLOSECOUNT")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsmt.AddTextBoxColumn("OSPSMTPNLQTY", 120)
              .SetLabel("PNL")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsmt.AddTextBoxColumn("OSPSMTPCSQTY", 120)
              .SetLabel("PCS")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
            costtotlotsmt.AddTextBoxColumn("OSPSMTDEFECTQTY", 120)
              .SetLabel("DEFECT")
              .SetTextAlignment(TextAlignment.Right)
              .SetDisplayFormat("#,##0", MaskTypes.Numeric);
        ...
        private void InitializeGrid_Detail()
        {
            ...
            grdSearch.View.AddTextBoxColumn("ENTERPRISEID", 200)
                .SetIsHidden();
            grdSearch.View.AddTextBoxColumn("SENDTIME", 200)
               .SetIsHidden();
            ...
            grdSearch.View.AddTextBoxColumn("DEFECTQTY", 120)
                .SetIsReadOnly()
                .SetLabel("DEFECTPCSQTY")
                .SetTextAlignment(TextAlignment.Right)
                .SetDisplayFormat("#,##0", MaskTypes.Numeric);                                //  pcsqty
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable dtSearchMaster = await SqlExecuter.QueryAsync("GetOutsourcingSettlementErrMaster", "10001", values);
        ...
        protected override void InitializeCondition()
        {
            ...
            //에러여부 
            InitializeConditionPopup_ISERROR();
        }
        ...
        protected override void InitializeConditionControls()
        {
            ...
            // TODO : 조회조건의 컨트롤에 기능 추가가 필요한 경우 사용 		Id	"P_SEARCHDATE"	string
            Conditions.GetControl<SmartPeriodEdit>("P_SEARCHDATE").LanguageKey = "SENDPERIOD";
            // Conditions.GetControl<SmartPeriodEdit>("P_SEARCHDATE").LanguageKey = "ISERROR";
        }
        ...
        private void focusedRowChangedMaster()
        {
            ...
            Param.Add("P_ISERROR", values["P_ISERROR"].ToString());
            ...
            DataTable dtDetail = SqlExecuter.Query("GetOutsourcingSettlementErrList", "10001", Param);
        ...
        private void focusedRowChangedDetail()
        {
            ...
            Param.Add("LANGUAGETYPE", UserInfo.Current.LanguageType);
            Param = Commons.CommonFunction.ConvertParameter(Param);
            DataTable dtDetail = SqlExecuter.Query("GetOutsourcingCostStatusListDetail", "10001", Param);
            grdSearchDetail.DataSource = dtDetail;
            DataTable dtReduce = SqlExecuter.Query("GetOutsourcingCostStatusListReduce", "10001", Param);
