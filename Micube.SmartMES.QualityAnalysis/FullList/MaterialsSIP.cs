...
namespace Micube.SmartMES.QualityAnalysis
{
    ...
    /// 
    /// </summary>
    public partial class MaterialsSIP : SmartConditionManualBaseForm
    {
        ...
        {
            grdMain.LanguageKey = "MATERIALSSIP";
        ...
        private void InitializeGrid()
        {
            ...
            group.AddTextBoxColumn("INSPECTIONQTY", 80).SetLabel("EXTERIORINSPECTIONQTY").SetValidationIsRequired().SetTextAlignment(TextAlignment.Left);
            ...
            group.AddTextBoxColumn("PARTICLEUNDERTAPE", 60).SetTextAlignment(TextAlignment.Right);
            group.AddTextBoxColumn("DISCOLORATION", 60).SetTextAlignment(TextAlignment.Right);
            group.AddTextBoxColumn("FOREIGNBOYD", 60).SetTextAlignment(TextAlignment.Right);
            group.AddTextBoxColumn("SOLDERBUMP", 60).SetTextAlignment(TextAlignment.Right);
            group.AddTextBoxColumn("COPPEREXPOSURE", 60).SetTextAlignment(TextAlignment.Right);
        ...
        public void InitializeEvent()
        {
            ...
            btnFullList.Click += (s, e) =>
            {
                try
                {
                    ...
                    // 저장된 엑셀을 시트에 넣는다.
                    if (CommonFunction.GetFtpImageFileToByte(@"FULLLIST/Materials_SIP.xlsx", true) is byte[] excelByte)
                    {
                        ...
                        for (int i = 0; i < grdMain.View.DataRowCount; i++)
                        {
                            ...
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("D", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "INCOMQTY"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("E", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "VENDOR"));
                            ...
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("H", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "MATERIALSTYPE"));
                            ...
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("N", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "SCRATCH"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("O", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "BUMP"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("P", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "PARTICLEUNDERTAPE"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("Q", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "DISCOLORATION"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("R", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "FOREIGNBOYD"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("S", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "SOLDERBUMP"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("T", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "COPPEREXPOSURE"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("U", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "INSPECTIONUSER"));
                            sheet.Document.Worksheets.ActiveWorksheet.Cells[string.Concat("V", i + 6)].SetValueFromText(DefectMapHelper.StringByDataRowObejct(dr, "FINALJUDGMENT"));
        ...
        protected override void OnToolbarSaveClick()
        {
            ...
            ExecuteRule("MaterialsSIP", grdMain.GetChangedRows());
        }
        ...
        protected async override Task OnSearchAsync()
        {
            try
            {
                ...
                if (await SqlExecuter.QueryAsync("GetMaterialsSIP", "10001", Conditions.GetValues()) is DataTable dt)
                {
