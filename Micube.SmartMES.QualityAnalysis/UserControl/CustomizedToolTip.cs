...
namespace Micube.SmartMES.QualityAnalysis
{
    ...
    /// <summary>
    /// 프 로 그 램 명  : CustomizedToolTip to create tooltips with Image.
    /// 업  무  설  명  : 신뢰성 검증 결과등록 화면에서 이미지 프리뷰 기능
    /// 생    성    자  : 유석진
    /// 생    성    일  : 2019-09-29
    /// 수  정  이  력  : 
    /// </summary>
    internal class CustomizedToolTip : ToolTip
    {
        ...
        private const int TOOLTIP_HEIGHT = 300;
        ...
        void CustomizedToolTip_Draw(object sender, DrawToolTipEventArgs e)
        {
            try
            {
                ...
                if (toolTipImage != null)
                {
                    ...
                    e.Graphics.DrawString("", myFont, myTextBrush, myTextRectangle, myTextFormat);
                }
                else
                {
                    e.Graphics.DrawString("", myFont, myTextBrush, myImageRectangle, myTextFormat);
                }
            }
