...
{
    public partial class ManufacturingHistoryPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        /// <summary>
        /// 팝업진입전 그리드의 Row
        /// </summary>
        ...
        public ManufacturingHistoryPopup()
        {
            InitializeComponent();
        ...
        private void BtnApply_Click(object sender, EventArgs e)
        {
            ...
            DataTable pDt = tParent.DataSource as DataTable;
