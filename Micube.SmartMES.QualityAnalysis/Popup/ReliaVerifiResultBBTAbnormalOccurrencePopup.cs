...
namespace Micube.SmartMES.QualityAnalysis
{
    ...
    /// 
    /// </summary>
    public partial class ReliaVerifiResultBBTAbnormalOccurrencePopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        /// 팝업진입전 그리드의 컨트롤
        /// </summary>
        public ReliabilityVerificationAbnormalOccurrenceBBT ParentControl { get; set; }
        ...
        public ReliaVerifiResultBBTAbnormalOccurrencePopup(DataRow dr)
        {
            InitializeComponent();
