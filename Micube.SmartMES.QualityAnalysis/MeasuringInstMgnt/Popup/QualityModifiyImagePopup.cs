...
{
    /// <summary>
    /// 프 로 그 램 명  : 품질관리> 계측기> 이력카드 등록 Popup
    /// 업  무  설  명  : 사진 수정 팝업
    /// 생    성    자  : 이승우
    /// 생    성    일  : 2019-11-09
    /// 수  정  이  력  : 
    /// 2019-11-09 : 이승우 직접 조회 및 단일 조회 형으로 수정.
    /// 2019-10-15 : 정승원 최초 개발
    /// 
    /// </summary>
    public partial class QualityModifiyImagePopup : SmartPopupBaseForm, ISmartCustomPopup
	{
		...
		public QualityModifiyImagePopup(string inspectionDefId, DataRow row)
		{
			InitializeComponent();
