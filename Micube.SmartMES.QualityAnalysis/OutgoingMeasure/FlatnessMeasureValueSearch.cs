...
{
    /// <summary>
    /// 프 로 그 램 명  : 품질관리 > 출하검사 > 평탄도 측정값 조회
    /// 업  무  설  명  : 평탄도 설비 인퍼페이스 Data의 조회화면
    /// 생    성    자  : 전우성
    /// 생    성    일  : 2020-02-28
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class FlatnessMeasureValueSearch : SmartConditionManualBaseForm
    {
        ...
        public FlatnessMeasureValueSearch()
        {
            InitializeComponent();
        }
        ...
        public void InitializeEvent()
        {
            ...
            grdMain.View.DoubleClick += (s, e) =>
            {
                ...
                {
                    popupFlatnessMeasure popup = new popupFlatnessMeasure()
                    {
        ...
        protected async override Task OnSearchAsync()
        {
            try
            {
                ...
                value.Add("P_SPECCLASSID", "SAVE_MEASURE_FLATNESS");

                if (await SqlExecuter.QueryAsync("GetOutgoingFlatnessMeasureList", "10001", 
