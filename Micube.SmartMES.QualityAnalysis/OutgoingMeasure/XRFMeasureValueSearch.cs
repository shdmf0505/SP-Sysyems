...
{
    /// <summary>
    /// 프 로 그 램 명  : 품질관리 > 출하검사 > XRF 측정값 조회
    /// 업  무  설  명  : XRF 설비 인퍼페이스 Data의 조회화면
    /// 생    성    자  : 전우성
    /// 생    성    일  : 2020-03-02
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class XRFMeasureValueSearch : SmartConditionManualBaseForm
    {
        ...
        public void InitializeEvent()
        {
            ...
            grdMain.View.DoubleClick += (s, e) =>
            {
                ...
                {
                    popupXRFMeasure popup = new popupXRFMeasure()
                    {
        ...
        protected async override Task OnSearchAsync()
        {
            try
            {
                ...
                value.Add("P_SPECCLASSID", "SAVE_MEASURE_XRF");

                if (await SqlExecuter.QueryAsync("GetOutgoingXRFMeasureList", "10001", DefectMapHelper.AddLanguageTypeToConditions(value)) is DataTable dt)
                {
