...
{
    /// <summary>
    /// 프 로 그 램 명  : 수율의 조회 조건에 Lot List 팝업이 사용되는 User Control
    /// 업  무  설  명  : 수율화면 Lot List에 들어가는 공통 모듈
    /// 생    성    자  : 전우성
    /// 생    성    일  : 2019-10-25
    /// 필  수  처  리  :
    /// 
    /// </summary>
    public partial class popupLotListByPeriod : SmartPopupBaseForm, ISmartCustomPopup
    {
        #region Interface
        ...
        private void InitializeLanguageKey()
        {
            ...
            layoutMain.SetLanguageKey(layoutLot, "LOTID");
            layoutMain.SetLanguageKey(layoutProduct, "PRODUCTDEFID");

            this.LanguageKey = "GRIDLOTLIST";
        ...
        private void InitializeGrid()
        {
            ...
            grdMain.View.AddTextBoxColumn("P_LOTID", 180).SetLabel("LOTID");
        ...
        private void Search()
        {
            ...
            grdMain.DataSource = SqlExecuter.Query("GetDefectMapLotList", "10002", value);
        }
        ...
        public void SetParams(string from, string to, string lot)
        {
            dtpFrom.Text = from;
            dtpTo.Text = to;
            txtLot.Text = lot;
