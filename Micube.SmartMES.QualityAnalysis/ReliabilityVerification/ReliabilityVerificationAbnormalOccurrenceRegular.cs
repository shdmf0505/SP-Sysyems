...
namespace Micube.SmartMES.QualityAnalysis
{
    ...
    /// 
    /// </summary>
    public partial class ReliabilityVerificationAbnormalOccurrenceRegular : SmartConditionManualBaseForm
    {
        ...
        /// 생성자
        /// </summary>
        public ReliabilityVerificationAbnormalOccurrenceRegular()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrdReliabiVerifiAbnormalOccurenceRegular()
        {
            ...
            grdReliabiVerifiAbnormalOccurenceRegular.GridButtonItem = GridButtonItem.Export;
            ...
            //진행현황
            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("STATE", 150)
                .SetLabel("PROCESSSTATUS");

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("INSPECTIONDATE", 150);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("PRODUCTDEFID", 150);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("PRODUCTDEFNAME", 150);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("PRODUCTDEFVERSION", 80).SetTextAlignment(TextAlignment.Center); // 품목Version

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("LOTID", 180).SetTextAlignment(TextAlignment.Center);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("DEFECTNAME", 150);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("QCSEGMENTNAME", 150);

            //마감여부
            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("ISCLOSE", 150).SetTextAlignment(TextAlignment.Center);
            // 재의뢰여부
            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("ISREREQUEST", 150).SetTextAlignment(TextAlignment.Center);

            //원인
            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("REASONCONSUMABLEDEFNAME", 150)
                .SetLabel("REASONPRODUCTDEFNAME");

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("REASONCONSUMABLEDEFVERSION", 150);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("REASONCONSUMABLELOTID", 150)
                .SetLabel("CAUSEMATERIALLOT");

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("REASONSEGMENTNAME", 150);

            grdReliabiVerifiAbnormalOccurenceRegular.View.AddTextBoxColumn("REASONAREANAME", 150);
        ...
        private void GrdReliabiVerifiAbnormalOccurenceRegular_DoubleClick(object sender, EventArgs e)
        {
            ...
            DataRow row = grdReliabiVerifiAbnormalOccurenceRegular.View.GetFocusedDataRow();

            ReliaVerifiResultRegularAbnormalOccurrencePopup popup = new ReliaVerifiResultRegularAbnormalOccurrencePopup(row);
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            dt = await SqlExecuter.QueryAsync("ReliabilityVerificationAbnormalOccurrenceRegularList", "10001", values);
        ...
        private void InitializeConditionPopup_DefectCode()
        {
            ...
            // 팝업 조회조건
            defectCodePopup.Conditions.AddTextBox("TXTDEFECTCODENAME").SetLabel("DEFECTCODENAME");
