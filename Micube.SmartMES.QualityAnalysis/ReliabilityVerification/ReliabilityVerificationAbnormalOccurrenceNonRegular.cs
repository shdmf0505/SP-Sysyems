...
namespace Micube.SmartMES.QualityAnalysis
{
    ...
    /// 
    /// </summary>
    public partial class ReliabilityVerificationAbnormalOccurrenceNonRegular : SmartConditionManualBaseForm
    {
        ...
        /// 생성자
        /// </summary>
        public ReliabilityVerificationAbnormalOccurrenceNonRegular()
        {
            InitializeComponent();
        }
        ...
        private void GrdReliabiVerifiAbnormalOccurenceRegular_DoubleClick(object sender, EventArgs e)
        {
            ...
            ReliaVerifiResultNonRegularAbnormalOccurrencePopup popup = new ReliaVerifiResultNonRegularAbnormalOccurrencePopup(grdReliabiVerifiAbnormalOccurenceRegular.View.GetFocusedDataRow());
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            dt = await SqlExecuter.QueryAsync("ReliabilityVerificationAbnormalOccurrenceNonRegularList", "10002", values);
