...
{
    public partial class GridGroupTest : SmartConditionManualBaseForm
    {
        ...
        {
            // TODO : 그리드 초기화 로직 추가
            var mainGroup = grdMain.View.AddGroupColumn("Group1");

            mainGroup.AddTextBoxColumn("Column1", 120);
            mainGroup.AddTextBoxColumn("Column2", 100)
                .SetIsHidden();
            mainGroup.AddTextBoxColumn("Column3", 100);
