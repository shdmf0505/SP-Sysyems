...
{
    /// <summary>
    /// 프 로 그 램 명  : 제조PM실적등록팝업
    /// 업  무  설  명  : 제조PM의 실적을 등록하는 팝업
    /// 생    성    자  : 김용조
    /// 생    성    일  : 2019-09-16
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class RegistResultMaintWorkOrderProductPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        public RegistResultMaintWorkOrderProductPopup(string workOrderID, string plantID, string isModify)
        {
            InitializeComponent();
            InitializeEvent();
        ...
        void DisplayMaintWorkOrderInfo(DataRow workOrderRow)
        {
            ...
            deStartCheckDate.EditValue = workOrderRow.GetString("STARTTIME");
            deFinishCheckDate.EditValue = workOrderRow.GetString("FINISHTIME");
        }
        #endregion
