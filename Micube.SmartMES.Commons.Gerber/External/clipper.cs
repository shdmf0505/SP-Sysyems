    ...
    public class Clipper : ClipperBase
    {
        ...
        private void JoinCommonEdges()
        {
            for (int i = 0; i < m_Joins.Count; i++)
            {
                ...
                if (!JoinPoints(j, out OutPt p1, out OutPt p2))
                {
                    continue;
                }
        ...
        {
            private readonly Polygons m_p;
            private Polygon currentPoly;
            private List<DoublePoint> normals = new List<DoublePoint>();
            private readonly double m_delta, m_rmin;
            private double m_r;
            private readonly int m_i, m_j;
            private int m_k;
        ...
        public static Polygons SimplifyPolygons(Polygons polys, PolyFillType fillType = PolyFillType.pftEvenOdd)
        {
            Polygons result = new Polygons();
            Clipper c = new Clipper
            {
