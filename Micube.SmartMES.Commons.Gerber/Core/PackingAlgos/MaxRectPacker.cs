...
*/
        ...
        public MaxRectPacker(int width, int height, bool rotations = true) => Init(width, height, rotations);
        ...
        private bool IsContainedIn(Rect a, Rect b) => a.x >= b.x && a.y >= b.y && a.x + a.width <= b.x + b.width && a.y + a.height <= b.y + b.height;
    }
}