...
namespace Micube.SmartMES.Commons.Gerber.Core.Primitives
{
    public class PointD
    {
        ...
        private double LengthSquared() => X * X + Y * Y;
        ...
        public double Dot(PointD B) => X * B.X + Y * B.Y;
        ...
        public static bool operator ==(PointD a, PointD b)
        {
            ...
            return (a is null) || (b is null) ? false : a.X == b.X && a.Y == b.Y;
        }

        public static bool operator !=(PointD x, PointD y) => !(x == y);
        ...
        public static PointD operator *(PointD a, float b) => new PointD(a.X * b, a.Y * b);

        public override string ToString() => string.Format("{0:N2},{1:N2}", X, Y);

        public PointF ToF => new PointF((float)X, (float)Y);
