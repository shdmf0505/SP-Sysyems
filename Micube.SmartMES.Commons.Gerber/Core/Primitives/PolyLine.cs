...
namespace Micube.SmartMES.Commons.Gerber.Core.Primitives
{
    public class PolyLine
    {
        ...
        public PointD Start => Vertices[0];
        public PointD End => Vertices[Vertices.Count - 1];
        public int Count => Vertices.Count;
        public void Add(double x, double y) => Vertices.Add(new PointD(x, y));
        ...
        public void MakeRoundedRect(PointD TopLeft, PointD BottomRight, double BorderRadiusInMM)
        {
            ...
            else
            {
                ...
                {
                    double P = (i * Math.PI / 2.0) / radcount;
