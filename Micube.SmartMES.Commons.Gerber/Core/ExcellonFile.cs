...
namespace Micube.SmartMES.Commons.Gerber
{
    ...
    public class ExcellonFile
    {
        ...
        private bool ParseExcellon(List<string> lines, double drillscaler)
        {
            Tools.Clear();
                                                    ...
                                                    case 'T':
                                                        {
                                                            ...
                                                            {
                                                                ID = (int)GCC.numbercommands[0],
                                                                Radius = GNF.ScaleFileToMM(GCC.GetNumber('C')) / 2.0f
                                                            };
