...
namespace Micube.SmartMES.Commons.Controls
{
    ...
    /// 
    /// </summary>
    public partial class ucApproval : UserControl, IDisposable, IEventAggregatorSubscriber
    {
        ...
        {
            ApprovalRegistPopup approvalRegistPopup = new ApprovalRegistPopup(UserInfo.Current.Enterprise, UserInfo.Current.Plant);
