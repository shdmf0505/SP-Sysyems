...
{
    public partial class ProductSpecificationEtcInfo2 : UserControl
    {

        DataTable DataSource = new DataTable();
        #region 생성자 

        public ProductSpecificationEtcInfo2()
        {
            InitializeComponent();
        ...
        private void InitializeTextControl()
        {
            ...
            TextBoxHelper.SetMarkMask(Mark.XAxisDecimalPoint, tbInputNumaxisX);
            TextBoxHelper.SetMarkMask(Mark.YAxisDecimalPoint, tbInputNumaxisY);
        }
        ...
        public DataTable Etcreturn()

        {

            DataSource = new DataTable();
            ReportTableReturn.GetLabelDataTable(tlpEtcInfo, DataSource);


            DataRow row = DataSource.NewRow();
            ReportTableReturn.GetDataRow(row, tlpEtcInfo);
