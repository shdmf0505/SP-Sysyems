...
{
    public partial class ProductSpecificationEtcInfo_YPE : UserControl
    {
        #region 생성자 
        public ProductSpecificationEtcInfo_YPE()
        {
            InitializeComponent();
        ...
        {
            return MemoSpecNote1.EditValue;
        }


        public object change1()
        {
            return MemoSpecChange1.EditValue;
        }
