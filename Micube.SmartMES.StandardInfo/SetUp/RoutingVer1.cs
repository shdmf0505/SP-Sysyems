...
namespace Micube.SmartMES.StandardInfo
{
    ...
    /// 수정 이 력 : 
    /// </summary> 
    public partial class RoutingVer1 : SmartConditionBaseForm
	{
		...
		private void InitializeGridList()
		{
            ...
            grdOperation.View.AddTextBoxColumn("ENTERPRISEID",100).SetIsHidden();
            grdOperation.View.AddTextBoxColumn("ASSEMBLYROUTINGID", 100).SetIsHidden();
            ...
            grdBomComp.View.AddComboBoxColumn("PLANTID", 80, new SqlQuery("GetPlantList", "10002", $"ENTERPRISEID={UserInfo.Current.Enterprise}", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"), "PLANTNAME", "PLANTID");
            ...
            grdBomComp.View.AddComboBoxColumn("COMPONENTUOM", 80, new SqlQuery("GetUOMList", "10001", $"ENTERPRISEID={UserInfo.Current.Enterprise}"), "UOMDEFNAME", "UOMDEFID");
            ...
            grdOperationspecvalue.View.AddComboBoxColumn("AOIQCLAYER", 100, new SqlQuery("GetCodeList", "00001", "CODECLASSID=UserLayer", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"));
            grdOperationspecvalue.View.AddComboBoxColumn("AOIQCLAYER2", 100, new SqlQuery("GetCodeList", "00001", "CODECLASSID=UserLayer", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"));
        ...
        private void grdOperation_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (dataRow["OPERATIONID"].ToString() != "")
            {
               ...
               // ParamComp.Add("ASSEMBLYITEMVERSION", dataRow["ASSEMBLYITEMVERSION"].ToString());
                ...
                DataTable dtComp = SqlExecuter.Query("GetBomcompmentlistVer1", "10001", ParamComp);
                grdBomComp.DataSource = dtComp;
        ...
        private void grdOperation_AddingNewRow(Framework.SmartControls.Grid.BandedGrid.SmartBandedGridView sender, Framework.SmartControls.Grid.AddNewRowArgs args)
        {
            ...
            dataRow = treeRouting.GetFocusedDataRow();
            if(dataRow == null)
            {
                dataRow = grdRouting.View.GetFocusedDataRow();
            }
            args.NewRow["ENTERPRISEID"] = dataRow["ENTERPRISEID"];
            args.NewRow["PLANTID"] = dataRow["PLANTID"];
        ...
        private void TreeRouting_FocusedNodeChanged(object sender, DevExpress.XtraTreeList.FocusedNodeChangedEventArgs e)
        {
            ...
            if (focusRow != null)
            {
                ...
                grdOperation.DataSource = SqlExecuter.Query("GetOperationVer1list", "10001", param);
        ...
        private void InitializeTree()
        {
           ...
           // treeRouting.SetEmptyRoot(rowFocu["ASSEMBLYITEMID"].ToString() + " " + rowFocu["ASSEMBLYITEMVERSION"].ToString(), "A");
            ...
            DataTable dt = SqlExecuter.Query("GetRountingTreeVer1", "10001", param);
        ...
        protected override void OnToolbarSaveClick()
        {
            ...
            if (dtRouting.Rows.Count != 0)
            {
                ...
                string sASSEMBLYITEM = "";
                if (dtRouting.Rows[0]["ASSEMBLYITEMCLASS"].ToString() != "SubAssembly")
                {
                    Dictionary<string, object> paramReverse = new Dictionary<string, object>();
                    paramReverse.Add("ENTERPRISEID", dtRouting.Rows[0]["ENTERPRISEID"].ToString());
                    paramReverse.Add("ASSEMBLYITEMID", dtRouting.Rows[0]["ASSEMBLYITEMID"].ToString());
                    paramReverse.Add("ASSEMBLYITEMVERSION", dtRouting.Rows[0]["ASSEMBLYITEMVERSION"].ToString());
                    DataTable dtBomReverse = SqlExecuter.Query("GetRountingReverseTree", "10001", paramReverse);

                    // 제품
                    sASSEMBLYITEM = dtBomReverse.Rows[0]["ASSEMBLYITEMID"].ToString() + dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"].ToString();

                    rowOperation["MAINPRODUCTID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"].ToString();
                    rowOperation["MAINPRODUCTVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"].ToString();
            ...
            if (dtOperationup.Rows.Count != 0)
            {
                ...
                foreach (DataRow dataRow in  dtOperationup.Rows)
                {
                    ...
                    if (rowFocu["MASTERDATACLASSID"].ToString() == "OperationItem")
                    {
                        ...
                        else
                        {
                            if(dataRow["PROCESSSEGMENTID_OLD"].ToString() != "")
                            {
                                ...
                                Dictionary<string, object> paramReverse = new Dictionary<string, object>();
                                paramReverse.Add("ENTERPRISEID", rowFocu["ENTERPRISEID"].ToString());
                                paramReverse.Add("ASSEMBLYITEMID", rowFocu["ASSEMBLYITEMID"].ToString());
                                paramReverse.Add("ASSEMBLYITEMVERSION", rowFocu["ASSEMBLYITEMVERSION"].ToString());
                                DataTable dtBomReverse = SqlExecuter.Query("GetRountingReverseTree", "10001", paramReverse);
                                ...
                                ParamProcesspath.Add("PROCESSDEFID", dtBomReverse.Rows[0]["ASSEMBLYITEMID"].ToString());
                                ParamProcesspath.Add("PROCESSDEFVERSION", dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"].ToString());
                    ...
                    else
                    {
                        ...
                        else
                        {
                            Dictionary<string, object> ParamProcesspath = new Dictionary<string, object>();
                            ParamProcesspath.Add("ENTERPRISEID", UserInfo.Current.Enterprise);
                            ParamProcesspath.Add("PROCESSDEFID", rowFocu["ASSEMBLYITEMID"]);
                            ParamProcesspath.Add("PROCESSDEFVERSION", rowFocu["ASSEMBLYITEMVERSION"]);
                        ...
                        rowPROCESSPATH["PROCESSDEFID"] = rowFocu["ASSEMBLYITEMID"];
                        rowPROCESSPATH["PROCESSDEFVERSION"] = rowFocu["ASSEMBLYITEMVERSION"];
                ...
                if (rowFocu["MASTERDATACLASSID"].ToString() == "OperationItem")
                {
                    ...
                    ParamStartend.Add("PROCESSDEFID", dtBomReverse.Rows[0]["ASSEMBLYITEMID"]);
                    ParamStartend.Add("PROCESSDEFVERSION", dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"]);
            ...
            if (dtBomComp.Rows.Count != 0)
            {
                ...
                DataRow rowRoutingFocu = grdRouting.View.GetFocusedDataRow();
                ...
                foreach (DataRow rowBomComp in dtBomComp.Rows)
                {
                    ...
                    if (rowRoutingFocu["MASTERDATACLASSID"].ToString() == "OperationItem")
                    {
                        ...
                        Dictionary<string, object> paramReverse = new Dictionary<string, object>();
                        paramReverse.Add("ENTERPRISEID", rowRoutingFocu["ENTERPRISEID"].ToString());
                        paramReverse.Add("ASSEMBLYITEMID", rowRoutingFocu["ASSEMBLYITEMID"].ToString());
                        paramReverse.Add("ASSEMBLYITEMVERSION", rowRoutingFocu["ASSEMBLYITEMVERSION"].ToString());
                        DataTable dtBomReverse = SqlExecuter.Query("GetRountingReverseTree", "10001", paramReverse);

                        rowBILLOFMATERIAL["PRODUCTDEFID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"];
                        rowBILLOFMATERIAL["PRODUCTDEFVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"];
                        rowBILLOFMATERIAL["PROCESSDEFID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"];
                        rowBILLOFMATERIAL["PROCESSDEFVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"];
                    ...
                    else
                    {
                        ...
                        rowBILLOFMATERIAL["PRODUCTDEFID"] = rowRoutingFocu["ASSEMBLYITEMID"];
                        rowBILLOFMATERIAL["PRODUCTDEFVERSION"] = rowRoutingFocu["ASSEMBLYITEMVERSION"];
                        rowBILLOFMATERIAL["PROCESSDEFID"] = rowRoutingFocu["ASSEMBLYITEMID"];
                        rowBILLOFMATERIAL["PROCESSDEFVERSION"] = rowRoutingFocu["ASSEMBLYITEMVERSION"];
                    }
                    ...
                    if(rowTool["_STATE_"].ToString() == "modified")
                    {
                        if(rowTool["RESOURCEID"] != rowTool["RESOURCEIDOLD"])
                        {
                            ...
                            if (dataRowtree["MASTERDATACLASSID"].ToString() == "OperationItem")
                            {
                                ...
                                rowBr["PRODUCTDEFID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"];
                                rowBr["PRODUCTDEFVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"];
                                rowBr["PROCESSDEFID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"];
                                rowBr["PROCESSDEFVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"];
                            }
                            else
                            {
                                rowBr["PRODUCTDEFID"] = rowRoutingFocu["ASSEMBLYITEMID"];
                                rowBr["PRODUCTDEFVERSION"] = rowRoutingFocu["ASSEMBLYITEMVERSION"];
                                rowBr["PROCESSDEFID"] = rowRoutingFocu["ASSEMBLYITEMID"];
                                rowBr["PROCESSDEFVERSION"] = rowRoutingFocu["ASSEMBLYITEMVERSION"];
                            }
                            ...
                            if (rowRoutingFocu["MASTERDATACLASSID"].ToString() == "OperationItem")
                            {
                                ...
                                rowBrD["PRODUCTDEFID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"];
                                rowBrD["PRODUCTDEFVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"];
                                rowBrD["PROCESSDEFID"] = dtBomReverse.Rows[0]["ASSEMBLYITEMID"];
                                rowBrD["PROCESSDEFVERSION"] = dtBomReverse.Rows[0]["ASSEMBLYITEMVERSION"];
                            }
                            else
                            {
                                rowBrD["PRODUCTDEFID"] = rowRoutingFocu["ASSEMBLYITEMID"];
                                rowBrD["PRODUCTDEFVERSION"] = rowRoutingFocu["ASSEMBLYITEMVERSION"];
                                rowBrD["PROCESSDEFID"] = rowRoutingFocu["ASSEMBLYITEMID"];
                                rowBrD["PROCESSDEFVERSION"] = rowRoutingFocu["ASSEMBLYITEMVERSION"];
                            }
            ...
            if (dtSpecattribute != null)
            {
                if (dtSpecattribute.Rows.Count != 0)
                {
                    ...
                    //dtINSPECTIONITEMREL.Columns.Add("SEQUENCE");
                    //dtINSPECTIONITEMREL.Columns.Add("ENTERPRISEID");
                    //dtINSPECTIONITEMREL.Columns.Add("PLANTID");
                    //dtINSPECTIONITEMREL.Columns.Add("PROCESSSEGMENTID");
                    //dtINSPECTIONITEMREL.Columns.Add("INSPECTIONDEFID");
                    //dtINSPECTIONITEMREL.Columns.Add("INSPITEMCLASSID");
                    //dtINSPECTIONITEMREL.Columns.Add("AOIQCLAYER");

                    //dtINSPECTIONITEMREL.Columns.Add("VALIDSTATE");
                    //dtINSPECTIONITEMREL.Columns.Add("_STATE_");

                    //foreach (DataRow row in dtSpecattribute.Rows)
                    //{

                    //    DataRow rowOperation = grdOperation.View.GetFocusedDataRow();

                    //    DataRow rowOPERATIONSPECVALUE = dtOPERATIONSPECVALUE.NewRow();
                    //    rowOPERATIONSPECVALUE["OPERATIONID"] = rowOperation["OPERATIONID"];
                    //    rowOPERATIONSPECVALUE["OPERATIONSEQUENCE"] = rowOperation["OPERATIONSEQUENCE"];
                    //    rowOPERATIONSPECVALUE["SEQUENCE"] = row["AOISPECSEQUENCE"];
                    //    rowOPERATIONSPECVALUE["ENTERPRISEID"] = rowOperation["ENTERPRISEID"];
                    //    rowOPERATIONSPECVALUE["PLANTID"] = rowOperation["PLANTID"];
                    //    rowOPERATIONSPECVALUE["PROCESSSEGMENTID"] = rowOperation["PROCESSSEGMENTID"];
                    //    rowOPERATIONSPECVALUE["INSPECTIONDEFID"] = row["INSPECTIONDEFID"];
                    //    rowOPERATIONSPECVALUE["INSPITEMCLASSID"] = row["INSPITEMCLASSID"];
                    //    rowOPERATIONSPECVALUE["AOIQCLAYER"] = row["AOIQCLAYER"];
                    //    rowOPERATIONSPECVALUE["INSPITEMID"] = row["INSPITEMID"];
                    //    rowOPERATIONSPECVALUE["VALIDSTATE"] = "Valid";


                    //    Dictionary<string, object> paramOSV = new Dictionary<string, object>();
                    //    paramOSV.Add("OPERATIONID", rowOperation["OPERATIONID"]);
                    //    paramOSV.Add("OPERATIONSEQUENCE", rowOperation["OPERATIONSEQUENCE"]);
                    //    paramOSV.Add("SEQUENCE", row["AOISPECSEQUENCE"]);
                    //    paramOSV.Add("ENTERPRISEID", rowOperation["ENTERPRISEID"]);
                    //    DataTable dtOperationspecvalue = SqlExecuter.Query("GetOperationspecvalue", "10001", paramOSV);
                    ...
                    //            if(dtOperationspecvalue.Rows.Count !=0)
                    //            {
                    //                rowOPERATIONSPECVALUE["_STATE_"] = "modified";
                    //            }
                    //            else
                    //            {
                    //                rowOPERATIONSPECVALUE["_STATE_"] = "added";
                    //            }
                    //        }
                    //        else
                    //        {
                    ...
                    //    else
                    //    {
                    //        rowOPERATIONSPECVALUE["_STATE_"] = row["_STATE_"];
                    //    }




                    //    dtOPERATIONSPECVALUE.Rows.Add(rowOPERATIONSPECVALUE);
                    //}
        ...
        void fnSearch()
        {
            ...
            DataTable dRouting = SqlExecuter.Query("GetRoutingVer1", "10001", values);
            ...
            if (dRouting.Rows.Count == 0)
            {
              ...
              //  dtNew.Rows[0]["MASTERDATACLASSID"] = dt.Rows[0]["MASTERDATACLASSID"].ToString();
                ...
                dtNew.Rows[0]["ASSEMBLYTYPE"] = "Phantom";
        ...
        protected override void OnValidateContent()
		{
            ...
            if (focusRow == null)
            {
                focusRow = grdRouting.View.GetFocusedDataRow();
            }
