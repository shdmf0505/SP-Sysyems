...
namespace Micube.SmartMES.SPC
{
    ...
    /// 
    /// </summary>
    public partial class QualityTotalSpcStatus : SmartConditionManualBaseForm
    {
        ...
        private void InitializeGrid()
        {
            ...
            grdRowData.View.AddTextBoxColumn("EQUIPMENTTYPE", 100);
            ...
            grdRowData.View.AddTextBoxColumn("LAYERID", 100);
            grdRowData.View.AddTextBoxColumn("PANELID", 100);
            grdRowData.View.AddTextBoxColumn("DEGREE", 100);
            grdRowData.View.AddTextBoxColumn("DEFECTCODE", 100);
            grdRowData.View.AddTextBoxColumn("EVENTDATE", 100).SetIsHidden();
            grdRowData.View.AddTextBoxColumn("INSPECTIONDATEVIEW", 100).SetLabel("OCCURDATE");
            grdRowData.View.AddTextBoxColumn("INSPECTIONDATETIMEVIEWDATE", 100).SetIsHidden();
            ...
            grdOverRules.View.AddTextBoxColumn("EQUIPMENTTYPE", 100);
            ...
            grdOverRules.View.AddTextBoxColumn("LAYERID", 100);
            grdOverRules.View.AddTextBoxColumn("PANELID", 100);
            grdOverRules.View.AddTextBoxColumn("DEGREE", 100);
            grdOverRules.View.AddTextBoxColumn("DEFECTCODE", 100);
            grdOverRules.View.AddTextBoxColumn("EVENTDATE", 100).SetIsHidden();
            grdOverRules.View.AddTextBoxColumn("INSPECTIONDATEVIEW", 100).SetLabel("OCCURDATE");
            grdOverRules.View.AddTextBoxColumn("INSPECTIONDATETIMEVIEWDATE", 100).SetIsHidden();
        ...
        public void InitializeEvent()
        {
            ...
            ucXBar.SpcChartDirectMessageUserEventHandler += UcXBar_SpcChartDirectMessageUserEventHandler;
        }
        ...
        protected async override Task OnSearchAsync()
        {
            try
            {
                ...
                string inspectionType = param["P_INSPECTIONRESULTRESOUCETYPE"].ToSafeString();
                string layerType = param["P_SPCLAYERTYPE"].ToSafeString();
                if (inspectionType == "AOI")
                {
                    if (layerType == "*" || layerType == "")
                    {
                        this.InitializeGrid();
                        ShowMessage("AOI Type일 경우 Layer는 필수 선택입니다.");
                        return;
                    }
                }

                if (inspectionType == "BBT")
                {
                    param["P_SPCLAYERTYPE"] = "999";//BBT는 Layer 구분 하지 않으로 기본값 999입력 되어 있음.
                    values["P_SPCLAYERTYPE"] = "999";
                }
                ...
                //전체 조회 Count 조회.
                InputRawMaxCount = await SqlExecuter.QueryAsync("GetSpcTotalAnalysisRawMaxCount", "10001", values);
                ...
                {
                    _AnalysisParameter.dtInputRawData = await SqlExecuter.QueryAsync("GetSpcTotalAnalysisRaw", "10001", values);
                }
                else
                {
                ...
                //자료 조회    
                //if (await SqlExecuter.QueryAsync("GetSpcTotalAnalysisRaw", "10001", values) is DataTable dt)
                if (_AnalysisParameter.dtInputRawData != null)
                {
                    ...
                    switch (chartType.ToUpper())
                    {
                        ...
                        case "MR":
                            //Subgroup
                            _AnalysisParameter.dtInputRawMainFieldName.subgroupNameFiled = "CHARTSUBGROUP";
                            _AnalysisParameter.dtInputRawMainFieldName.subgroupNameFiledName = "CHARTSUBGROUPDEFECT";
                            _AnalysisParameter.dtInputRawMainFieldName.subgroupNameFiledName01 = "CHARTSUBGROUPPRODUCT";
                            //Sampling
                            switch (subgroupType)
                            {
                                case "LOTID":
                    ...
                    //불량률 계산 Data 생성.
                    SPCPara spcParaSta = new SPCPara();
                    spcParaSta.spcOption = SPCOption.Create();
                    spcParaSta.spcOption.limitType = LimitType.Interpretation;
                    spcParaSta.tableRawData = _AnalysisParameter.dtInputRawData;
                    spcParaSta.tableSubgroupSpec = null;
                    spcParaSta.ChartTypeMain("P");
                    switch (chartType.ToUpper())
                    {
                        case "P":
                        case "NP":
                        ...
                        case "I":
                        case "MR":
                            _AnalysisParameter.dtInputRawMainFieldName.subgroupNameFiled = "SUBGROUPNAME";
                            ...
                            this.ucXBar.DirectInputDataRead(ref spcParaSta, _AnalysisParameter);
                    ...
                    //불량률 계산 및 표시
                    this.DefectRateListView(spcParaSta);
            ...
            foreach (SpcConditionDateDays days in rtnlstDay)
            {
                ...
                if (niCount != 1)
                {
                    ...
                    try
                    {
                        ...
                        dtInputPartData = await SqlExecuter.QueryAsync("GetSpcTotalAnalysisRaw", "10001", param);
                ...
                else
                {
                    ...
                    try
                    {
                        dtInputFirstData = await SqlExecuter.QueryAsync("GetSpcTotalAnalysisRaw", "10001", param);
        ...
        public DataTable CreateOverRulesTable(string tableName = "dtOverRulesTable")
        {
            ...
            dt.Columns.Add("INSPECTIONDATEVIEW", typeof(string));
        ...
        private void DefectRateListView(SPCPara spcPara)
        {
            ...
            if (gridCaption != null && gridCaption.Length > 0 && gridCaption[1] != "")
            {
                ...
                {
                    colIndexAdd = colIndexDefault + i;
                    this.gridTotal.View.Columns[colIndexAdd-1].Caption = gridCaption[i];
        ...
        protected override void InitializeCondition()
        {
            ...
            //업무 구분
            this.Conditions.AddComboBox("P_INSPECTIONRESULTRESOUCETYPE", new SqlQuery("GetSpcSearchComboCom", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}", $"ENTERPRISEID={UserInfo.Current.Enterprise}", $"P_CODECLASSID={"SpcTotalInspectionType"}"), "CODENAME", "CODEID")
                .SetMultiColumns(ComboBoxColumnShowType.DisplayMemberOnly, false)
                .SetDefault("AOI")
                .SetValidationIsRequired()
                .SetLabel("검사구분")
            ...
            //AOI Layer
            this.Conditions.AddComboBox("p_SpcLayerType", new SqlQuery("GetSpcSearchComboCom", "10001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}", $"ENTERPRISEID={UserInfo.Current.Enterprise}", $"P_CODECLASSID={"SpcLayerType"}"), "CODENAME", "CODEID")
                .SetMultiColumns(ComboBoxColumnShowType.DisplayMemberOnly, false)
                .SetDefault("*")
                .SetValidationIsRequired()
                .SetLabel("LAYER")
                .SetPosition(3.1); // Subgroup 조회조건 
        }
        ...
        private void InitializeConditionPopup_Product()
        {
            ...
            */
            ...
            // 2020.05.11-유석진-SelectPopup 항목 추가
            var conditionProductId = Conditions.AddSelectPopup("p_productdefId", new SqlQuery("GetProductDefinitionList", "10001", $"PLANTID={UserInfo.Current.Plant}"), "PRODUCTDEFNAME", "PRODUCTDEFID")
                ...
                try
                {
                    for (int i = 0; i < staChartData.Rows.Count; i++)
                    {
                        ...
                        var dtGroupData = _AnalysisParameter.dtInputRawData.AsEnumerable()
                                                               .Where(x => x.Field<string>("CHARTSUBGROUP") == subGroupId)
                                                               .GroupBy(m => new { SUBGROUP = m.Field<string>("CHARTSUBGROUP") })
                                                               .Select(grp => new
                                                               {
                                                                   ...
                                                                   sEQUIPMENTTYPE = grp.Where(x => x.Field<object>("EQUIPMENTTYPE") != null).Max(x => x.Field<object>("EQUIPMENTTYPE").ToSafeString()),
                                                                   ...
                                                                   sLAYERID = grp.Where(x => x.Field<object>("LAYERID") != null).Max(x => x.Field<object>("LAYERID").ToSafeString()),
                                                                   sPANELID = grp.Where(x => x.Field<object>("PANELID") != null).Max(x => x.Field<object>("PANELID").ToSafeString()),
                                                                   sDEGREE = grp.Where(x => x.Field<object>("DEGREE") != null).Max(x => x.Field<object>("DEGREE").ToSafeString()),
                                                                   sDEFECTCODE = grp.Where(x => x.Field<object>("DEFECTCODE") != null).Max(x => x.Field<object>("DEFECTCODE").ToSafeString()),
                                                                   sEVENTDATE = grp.Where(x => x.Field<object>("EVENTDATE") != null).Max(x => x.Field<object>("EVENTDATE").ToSafeString()),
                                                                   sINSPECTIONDATEVIEW = grp.Where(x => x.Field<object>("INSPECTIONDATEVIEW") != null).Max(x => x.Field<object>("INSPECTIONDATEVIEW").ToSafeString()),
                                                                   ...
                                                                   sNVALUE = grp.Where(x => x.Field<object>("NVALUE") != null).Max(x => x.Field<object>("NVALUE").ToSafeDoubleStaMin()),
                                                                   sNSUBVALUE = grp.Where(x => x.Field<object>("NSUBVALUE") != null).Max(x => x.Field<object>("NSUBVALUE").ToSafeDoubleStaMin())
                                                               });
                        foreach (var s in dtGroupData)
                        {
                            ...
                            //SpcFunction.IsDbNckStringWrite(dataRowOverRule, "SUBGROUPNAME", srcData, "", SpcClass.SubGroupSymbolDb, SpcClass.SubGroupSymbolView);
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "EQUIPMENTTYPE", s.sEQUIPMENTTYPE.ToSafeString());
                            ...
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "LAYERID", s.sLAYERID.ToSafeString());
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "PANELID", s.sPANELID.ToSafeString());
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "DEGREE", s.sDEGREE.ToSafeString());
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "DEFECTCODE", s.sDEFECTCODE.ToSafeString());
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "EVENTDATE", s.sEVENTDATE.ToSafeString());
                            SpcFunction.IsDbNckStringWrite(dataRowOverRule, "INSPECTIONDATEVIEW", s.sINSPECTIONDATEVIEW.ToSafeString());
