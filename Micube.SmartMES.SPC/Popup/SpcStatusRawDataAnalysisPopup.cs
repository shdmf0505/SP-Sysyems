...
namespace Micube.SmartMES.SPC
{
    ...
    /// 
    /// </summary>
    public partial class SpcStatusRawDataAnalysisPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        /// 생성자
        /// </summary>
        public SpcStatusRawDataAnalysisPopup()
        {
            InitializeComponent();
            InitializeEvent();
            InitializeGrid();
        ...
        private void InitializeGrid()
        {
            ...
            grdRawData.View.AddTextBoxColumn("SUBGROUP", 150).SetLabel("SPCRAWDATAVIEWSUBGROUP");
            grdRawData.View.AddTextBoxColumn("SUBGROUPNAME", 150).SetLabel("SPCOVERDATAVIEWSAMPLINGNAMEXAXIS");
            grdRawData.View.AddTextBoxColumn("SAMPLING", 150).SetLabel("SPCRAWDATAVIEWSAMPLING");
            grdRawData.View.AddTextBoxColumn("SAMPLINGNAME", 150).SetLabel("SPCRAWDATAVIEWSAMPLINGNAME");
            grdRawData.View.AddSpinEditColumn("NSUBVALUE", 150)
        ...
        private void DataSummaryIMR()
        {
            try
            {
                ...
                var sumSubGroup = from b in RawData
                                  group b by new
                                  {
                                      b.GROUPID,
                                      b.SUBGROUP,
                                  ...
                                  select new
                                  {
                                      ...
                                      vSUBVALUEAVG = g.Average(s => s.NSUBVALUE.ToSafeDoubleZero()),
                                      vNVALUEAVG = g.Average(s => s.NVALUE),
                                  };
