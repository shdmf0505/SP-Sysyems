...
namespace Micube.SmartMES.SPC
{
    ...
    /// 
    /// </summary>
    public partial class SpcStatusRawDataPopup : SmartPopupBaseForm, ISmartCustomPopup
    {
        ...
        private void InitializeGrid()
        {
            ...
            grdRawData.View.AddTextBoxColumn("SAMPLEID", 100)
                ...
                .SetIsHidden(); 
            grdRawData.View.AddTextBoxColumn("SUBGROUP", 150)
                .SetLabel("SPCSUBGROUP")
                .SetIsHidden();
            grdRawData.View.AddTextBoxColumn("SAMPLING", 200)
                .SetLabel("SPCSAMPLING");
